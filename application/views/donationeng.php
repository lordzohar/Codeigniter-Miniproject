            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  echo site_url('Kisaan/select');?>">              
                    ...
                    <li>
                        <a href="<?php echo si1te_url('Kisaan/login');?>   ">लॉग इन</a>
                    </li>
                    <li>
	...
	<div class="container">
        <div class="row">
          <div class="col-lg-6  col-md-6 col-sm-12">
			<br><br><h2>RAISE FUNDS</h2>
                    <h5>We have raised fund of  </h5>
                    <span><strong><i class="fa fa-rupee"></i>50,10,345 </strong></span>
					<h6><b>If you want to donate<br>
					pleas enter your e-mail and amount of donation</b></h6>	
						<form>
                        <div class="form-group">
                            <input type="text" size=150px class="form-control" required="required" placeholder="Your Email">
                        </div>
                        <div class="form-group">
