   ...
   <img src="<?php echo base_url();?>img/btn2.png" alt="Next" id="next"> 
    ...
    <div class="container">
        ...
        <header class="jumbotron hero-spacer">
            ...
            <p><a class="btn btn-primary btn-large" href="/var/www/html/myedittoheroic/cc.html" >Call Customer Care!</a>
            </p>
        </header>
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            <a href="/var/www/html/myedittoheroic/crop.html" class="btn btn-primary">GO</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>
                             <a href="/var/www/html/myedittoheroic/technology.html" class="btn btn-primary">GO</a>
                        </p>
                    </div>
                </div>
            </div>
