    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?site_url('Kisaan/index');?>">स्वागत हे</a>
            </div>
...
<div class="storage">
    ...
    <br>
    <fieldset>
          <legend><h1>भंडारण खोज</h1></legend>
          <p>
             <label>क्षेत्र का चयन करें</label>
             <form action="#" method="post">
             <select id = "myList">
               <option value = <?php $a="maharastra";?>"maharastra">महाराष्ट्र</option>
          ...
          <br>
          <p>
                             <a href="https://www.olx.in/<?=$a;?>/lease/q-farm/" class="btn btn-default" d="shana">GO</a>
                        </p>
       </fieldset>
